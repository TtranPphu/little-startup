...
const slides = [
  {
    id: 1,
    image: "/student-learning.svg",
    title: "Học cùng Rewood – Hành trình của bạn luôn có người đồng hành",
    description: "Theo dõi tiến trình học tập và gợi ý bài học để phát triển hóa",
    progressPercent: "70%",
  },
  {
    id: 2,
    image: "/teacher-learning.svg",
    title: "Học cùng Rewood – Hành trình của bạn luôn có người đồng hành",
    description: "Giảng viên giàu kinh nghiệm hỗ trợ bạn trên từng bước đi trên lộ trình",
  },
  {
    id: 3,
    image: "/community-learning.svg",
    title: "Học cùng Rewood – Hành trình của bạn luôn có người đồng hành.",
              ...
              <div className="md:w-1/2 space-y-4 mt-6 md:mt-0">
                {slide.progressPercent && (
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-green-700 font-medium">{slide.progressPercent}</span>
                  </div>
                )}
